...
public class StaffClientSupportInput {
	...
	private String support_note;
	  ...
	  public StaffClientSupportInput() {}
	  public StaffClientSupportInput(LocalDate leavingday, String company, String occupation, String employ_type, Float working_hours, LocalDate joinday, String offer, String employed, String support_note) {
